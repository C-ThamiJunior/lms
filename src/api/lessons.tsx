...
interface MaterialUploadModalProps {
  modules: Module[];
  currentUser: User;
  onDataMutated: () => void; // Trigger refresh in parent
  onClose: () => void;
}
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        type: formData.type,
        url: formData.url || 'http://placeholder-url.com/resource', // Replace with real file upload logic if backend supports it
